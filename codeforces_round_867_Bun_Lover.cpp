...
Each test case is described by a single integer n
 (4≤n≤109
...
Output t
 integers. The i
-th of them should be equal to the total length of the chocolate layer in the i
-th test case.
*/
